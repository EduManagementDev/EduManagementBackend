package com.fzu.edumanagement.dao.redis;
...
@Repository
public class FZUNewsDAO {
    private static final String HASH_NAME = "rc_fzu_news";

    private final RedisTemplate template;

    public FZUNewsDAO(@Qualifier("redisTemplate") RedisTemplate template) {
